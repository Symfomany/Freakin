...
namespace Wks\SiteBundle\Form\Type;

use Symfony\Component\Form\AbstractType;
use Symfony\Component\Form\FormBuilderInterface;
use Doctrine\ORM\EntityRepository;
use Wks\SiteBundle\Form\Type\MediasUsersType;
...
class DemandeurHorairesType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        ->add('phrase', 'textarea', array('attr' => array('pattern' => '.{4,350}', 'maxlength' => 350 ),  'required' => false));
    ...
    public function getDefaultOptions(array $options) {
        return array(
            ...
            'validation_groups' => array('suscribe_step2'),
        );
    }

    public function getName() {
        return 'suscribe_step2';
    }
